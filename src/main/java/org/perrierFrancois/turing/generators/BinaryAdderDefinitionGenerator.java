...
public class BinaryAdderDefinitionGenerator extends TuringMachineDefinitionGeneratorSupport {
    ...
    private TuringMachineDefinition doBuildDefinition() {
        ...
        for (int b = 0; b < bits; b++) {
            ...
            fullAdder(actions, Move.RIGHT, bits, Move.RIGHT, bits + 1, i -> "addDigits" + finalB + "_" + i, nextState);

            if (b != bits - 1) {
                moveN(actions, i -> "moveToLeftOperandDigit" + (finalB + 1) + "_" + i, Move.LEFT, 2 * bits + 1, "addDigits" + (b + 1) + "_0");
            }
        }
    ...
    private void fullAdder(List<Action> actions,
                           ...
                           IntFunction<String> stateNameTemplate, String nextState) {
        //BRANCH 1: 0 + ?, C=?
...

        {
...

            {
                ...
                write(actions, read00_StateTemplate.apply(0), ZERO, nextState);
                ...
                write(actions, read000StateTemplate.apply(0), ZERO, nextState);
                ...
                write(actions, read001StateTemplate.apply(0), ZERO, nextState);
            }
...

            {
                ...
                write(actions, read01_StateTemplate.apply(0), ZERO, nextState);
                ...
                write(actions, read010StateTemplate.apply(0), ZERO, nextState);
                ...
                write(actions, read011StateTemplate.apply(0), ONE, nextState);
            }
        }
...

        {
...

            {
                ...
                write(actions, read10_StateTemplate.apply(0), ZERO, nextState);
                ...
                write(actions, read100StateTemplate.apply(0), ZERO, nextState);
                ...
                write(actions, read101StateTemplate.apply(0), ONE, nextState);
            }
...

            {
                ...
                write(actions, read11_StateTemplate.apply(0), ONE, nextState);
                ...
                write(actions, read110StateTemplate.apply(0), ONE, nextState);
                ...
                write(actions, read111StateTemplate.apply(0), ONE, nextState);
            }
        }
    }
}
